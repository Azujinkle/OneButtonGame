...
func _get_level_config(level_number: int) -> Dictionary:
	...
	if level_number == 2:
		return {
			...
			"response_window": 1.0,
			"audio": audio_config,
			"arrival_text": "Bus Driver: We are arriving at The Convention Center. Have a great convention!",
	...
	return {
		...
		"response_window": 1.5,
		"audio": audio_config,
		"arrival_text": "Bus Driver: We are arriving at The Business District. Have a great day!",
